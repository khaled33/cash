...
```
cd existing_repo
git remote add origin https://gitlab.endatamweel.tn/khaled/enda-cash-upgrade.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.endatamweel.tn/khaled/enda-cash-upgrade/-/settings/integrations)
